...
class CommandRunner implements Runnable{
	/**
	 * [ES] Metodo a ser ejecutado({@link com.jaxsandwich.framework.models.ModelCommand#getAction()}).<br>
	 * [EN] Method wich will be executed({@link com.jaxsandwich.framework.models.ModelCommand#getAction()}).
	 */
