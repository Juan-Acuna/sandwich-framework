...
public abstract class Bot extends ListenerAdapter{
	...
	/**
	 * [ES] Prefijo del bot. Se usa por defecto en todos los servidores({@link com.jaxsandwich.framework.models.discord.GuildConfig}) en los cuales no se ha especificado un prefijo.<br>
	 * [EN] Bot prefix. Is used as defaultin all the guilds({@link com.jaxsandwich.framework.models.discord.GuildConfig}) which doesn't have a specific prefix).
	 */
	protected String prefix = ">";
	/**
	 * [ES] Prefijo de opción del bot. Se usa por defecto en todos los servidores({@link com.jaxsandwich.framework.models.discord.GuildConfig}) en los cuales no se ha especificado un prefijo de opción.<br>
	 * [EN] Bot option prefix. Is used as default in all the guilds({@link com.jaxsandwich.framework.models.discord.GuildConfig}) which doesn't have a specific option prefix).
	 */
	protected String opt_prefix = "-";
	/**
	 * [ES] Indica si el bot esta encendido o apagado (enendido = escuchando comandos). Las categorías 'especiales' ({@link com.jaxsandwich.framework.annotations.Category}(special=true)) pueden ser escuchadas sin importar el estado de este atributo.<br>
	 * [EN] Indicates if the bot is on or off (on = listenning to commands). The 'special' categories ({@link com.jaxsandwich.framework.annotations.Category}(special=true)) can be executed no matter the value of this attribute.
	 * */
	...
	/**
	 * [ES] Gestor de configuración de servidores({@link com.jaxsandwich.framework.models.discord.GuildConfig}) del bot.<br>
	 * [EN] Manager of guilds config({@link com.jaxsandwich.framework.models.discord.GuildConfig}) of the bot.
	 */
	protected GuildsManager guildsManager;
	/**
	 * [ES] Gestor de comandos extra({@link com.jaxsandwich.framework.models.ModelExtraCommand}) del bot.<br>
	 * [EN] Manager of extra command({@link com.jaxsandwich.framework.models.ModelExtraCommand}) of the bot.
	 */
	...
	/**
	 * [ES] Analiza el evento({@link MessageReceivedEvent}) y ejecuta el comando({@link com.jaxsandwich.framework.models.ModelCommand}) si esta presente.<br>
	 * [EN] Analyzes the event({@link MessageReceivedEvent}) and executes the commad({@link com.jaxsandwich.framework.models.ModelCommand}) if it's present.
	 */
