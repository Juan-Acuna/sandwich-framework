...
public class MessageUtils {
	 ...
	 * @deprecated [ES] En su lugar use {@link Packet#SendAndDestroy(MessageEmbed, int, MessageEmbed...)}.<br>
	 * [EN] Better use {@link Packet#SendAndDestroy(MessageEmbed, int, MessageEmbed...)}.
	 */
	@Deprecated
	 ...
	 * @deprecated En su lugar use {@link Packet#SendAndDestroy(String, int)}.<br>
	 * [EN] Better use {@link Packet#SendAndDestroy(String, int)}.
	 */
	@Deprecated
	 ...
	 * @deprecated [ES] En su lugar use {@link Packet#SendAndDestroy(Message, int)}.<br>
	 * [EN] Better use {@link Packet#SendAndDestroy(Message, int)}.
	 */
	@Deprecated
	 ...
	 * [ES] Envía un {@link MessageEmbed} en el {@link MessageChannel} y se elimina después del tiempo especificado.<br>
	 * [EN] Sends a {@link MessageEmbed} to the {@link MessageChannel} and deletes itself after the specified time.<br>
	 * @deprecated [ES] En su lugar use {@link Packet#SendAndDestroy(MessageEmbed, int, TimeUnit)}.<br>
	 * [EN] Better use {@link Packet#SendAndDestroy(MessageEmbed, int, TimeUnit)}.
	 */
	@Deprecated
	 ...
	 * [ES] Envía un mensaje en el {@link MessageChannel} y se elimina después del tiempo especificado.<br>
	 * [EN] Sends a message to the {@link MessageChannel} and deletes itself after the specified time.<br>
	 * @deprecated [ES] En su lugar use {@link Packet#SendAndDestroy(String, int, TimeUnit)}.<br>
	 * [EN] Better use {@link Packet#SendAndDestroy(String, int, TimeUnit)}.
	 */
	@Deprecated
	 ...
	 * [ES] Envía un {@link Message} en el {@link MessageChannel} y se elimina después del tiempo especificado.<br>
	 * [EN] Sends a {@link Message} to the {@link MessageChannel} and deletes itself after the specified time.<br>
	 * @deprecated [ES] En su lugar use {@link Packet#SendAndDestroy(Message, int, TimeUnit)}.<br>
	 * [EN] Better use {@link Packet#SendAndDestroy(Message, int, TimeUnit)}.
	 */
	@Deprecated
