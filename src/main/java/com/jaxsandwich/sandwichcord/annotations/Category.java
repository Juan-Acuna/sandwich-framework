...
/**
 * [ES] Indica que la clase es una Categoría, la cual será convertida en un objeto {@link com.jaxsandwich.sandwichcord.models.ModelCategory} por el framework.<br>
 * [EN] Indicates that the class is a Category, which will be turned into a {@link com.jaxsandwich.sandwichcord.models.ModelCategory} object by the framework.
 * @author Juan Acuña
 * @version 1.2
 */
